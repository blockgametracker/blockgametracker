...
const navigation = ({page}: {page: string}) => {
    ...
    <Section className="fixed top-0 border-b-2 border-darkOverlay bg-darkFill bg-opacity-60 backdrop-blur-md z-50">
        <div className="w-full h-16 inline-flex items-center">
            ...
            <NavButton page="home" currentPage={page} href="/">Home</NavButton>
            <NavButton page="server-comparison" currentPage={page} href="/compare">Server comparison</NavButton>
            <NavButton page="as-statistics" currentPage={page} href="https://blockgametracker.gg/d/nlKArnQ4k/global-playercount-by-as">AS Statistics</NavButton>
        </div>
    </Section>
    )
}
