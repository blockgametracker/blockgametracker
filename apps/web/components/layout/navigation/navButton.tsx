    ...
    return (
        <li id={page}>
            <Link
                ...
                aria-label={page}
                href={href}
                className={`fade flex group flex-row items-center gap-4 w-full fade p-4 whitespace-nowrap hover:text-whiteMT hover:font-semibold dark:hover:font-normal ${
                    isActive
            ...
            >
                <div
                    className={`rounded-md border-2 p-2 ${isActive ? "bg-mainColor border-mainColor bg-opacity-15 dark:bg-opacity-15 dark:border-opacity-50" : "bg-whiteBorder dark:bg-darkBorder border-whiteBorder dark:border-darkBorder bg-opacity-25 dark:bg-opacity-25"}`}
                >
                    <Icon
                        iconName={iconName}
