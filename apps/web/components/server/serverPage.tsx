...
export const ServerPage = async (props: Props) => {
    ...
    return (
        <div className="w-full h-full flex flex-col tablet:flex-row justify-end">
            <Filters urlParams={props.urlParams} />

            <Content>
                <Container className="flex flex-col w-full h-96 tablet:w-5/6 tablet:h-full divide-y-2 divide-darkOverlay">
